...
import com.ddup.common.base.SeedProperties;
...
public class SystemCacheSelector implements BeanDefinitionRegistryPostProcessor {
    ...
    public void postProcessBeanDefinitionRegistry(@NonNull BeanDefinitionRegistry registry) throws BeansException {
        if (!finished) {
            ...
            yamlPropertiesFactoryBean.setResources(new ClassPathResource("seed.yml"));
            Properties properties = yamlPropertiesFactoryBean.getObject();
            if (properties != null) {
                enableRedisCache = Boolean.parseBoolean(properties.getProperty(SeedProperties.ENABLE_REDIS_CACHE));
            }
            if (!enableRedisCache) {
