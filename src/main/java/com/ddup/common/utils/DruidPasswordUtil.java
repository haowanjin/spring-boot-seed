...
public class DruidPasswordUtil {
    ...
    public static void main(String[] args) {
        System.out.println(JSON.toJSON(encrypt("root")));

        System.out.println(decrypt("MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAK4CoPJ0+ho6gml24G6NoU5XMScBf+Opz9zNKJMIJUKIvJm1y9Grnm+daCOfHQEnUGeXUQ5JMjxDbrNBdK39UDsCAwEAAQ==","a5mvpET8JOoPFXh+nIkFy1zN8a+gS/YrKwiSX8orHZTWVsGuA0hTshaZwqFejv0E7F0jLexlMsYa1WkUJ9ePlw=="));
    }
}
